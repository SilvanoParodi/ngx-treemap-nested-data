...
import { invertColor, id } from "@swimlane/ngx-charts/release/utils";

@Component({
  selector: "g[rs-charts-tree-map-cell-ml]",
  template: `
    <svg:g>
      <defs *ngIf="gradient">
        <svg:g
...
export class RsTreeMapCellComponentMultilevel implements OnChanges {
  @Input() data;
  @Input() fill;
  @Input() x;
  @Input() y;
